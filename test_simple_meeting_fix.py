#!/usr/bin/env python3
"""
Simple test for meeting transcript handling improvements
"""
...
from modules.utils import extract_meeting_transcript_modules, get_training_keywords_from_goals

def test_meeting_transcript_fallback():
    """Test the meeting transcript fallback function"""
    ...
    print("🧪 Testing meeting transcript fallback function...")
...
if __name__ == "__main__":
    success = test_meeting_transcript_fallback()
    if success:
        print("\n✅ Meeting transcript fallback test PASSED")
    else:
        print("\n❌ Meeting transcript fallback test FAILED") 